LANGUAGES = {
    'en': {
        ...
        'referral_reward': '✅ You received {amount}€ from your referral {user}',
        'gift': '🎁 Gift',
    ...
    'ru': {
        ...
        'referral_reward': '✅ Вы получили {amount}€ от своего реферала {user}',
        'gift': '🎁 Подарок',
    ...
    'lt': {
        ...
        'referral_reward': '✅ Gavote {amount}€ nuo pakviesto vartotojo {user}',
        'gift': '🎁 Dovana',
